...
Given Assumptions~\ref{ass:B1'} and \ref{ass:B2'}, Assumption~\ref{ass:sups} is satisfied with $c_{\tau(t),R}^{U}=\sup_{i\leq
...
\end{equation*}%
and $c_{\tau(t),R}^{L}=-c_{\tau(t),R}^{U}$ for the conditional case. Also, note that for both the unconditional and conditional cases, \hl{$\frac{N_{\tau(t)}^{1+\varepsilon
